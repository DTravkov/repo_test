...
#
# This is extended lecturer's code with some features from https://nerdparadise.com/programming/pygame/part6 , that i adopted and changed throughly to fit my needs
#
...
while pygame:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN and event.key == pygame.K_z: # circle drawing
        ...
        elif event.type == pygame.KEYDOWN and event.key == pygame.K_x:# rect drawing
        ...
        elif event.type == pygame.KEYDOWN and event.key == pygame.K_c:# triangle drawing
            size = (15 * brush_radius / 2)
            pygame.draw.polygon(screen,brush_color,((mouse_x-size,mouse_y+size),(mouse_x,mouse_y-size),(mouse_x+size,mouse_y+size)),3)
        elif event.type == pygame.KEYDOWN and event.key == pygame.K_v:# rhombus drawing
            center = (mouse_x,mouse_y)
            height = (15 * brush_radius / 2)
            width = (15 * brush_radius / 3)
            verteces = [
            ...
            pygame.draw.polygon(screen,brush_color,verteces,3)
