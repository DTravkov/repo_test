...
while running:
    delta_time = clock.tick(170) / 1000 # gets delta between last and current frame to enhance stability,and use some smooth features (like lerp,velocity damping, in unity or godot game enignes)
    ...
    for coin in coinlist: # coin manager
        coin.spawn(screen,delta_time)
